...
<div class="ph d-flex align-items-start justify-content-between">
    <div><h1>Notifikasi</h1><p>Pemberitahuan dari sistem dan balasan Admin</p></div>
...
<div class="card-a">
    @if($notifikasi->count())
    @php
        $icons  = ['info'=>'info','warning'=>'alert-triangle','danger'=>'alert-circle','success'=>'check-circle','flag'=>'message-square'];
        $colors = ['info'=>'var(--primary)','warning'=>'var(--warning)','danger'=>'var(--danger)','success'=>'var(--success)','flag'=>'var(--primary)'];
        $bgs    = ['info'=>'rgba(14,124,123,.1)','warning'=>'rgba(244,162,97,.1)','danger'=>'rgba(230,57,70,.1)','success'=>'rgba(45,198,83,.1)','flag'=>'rgba(14,124,123,.1)'];
    @endphp
    ...
    <div class="empty">
        ...
        <p>Notifikasi akan muncul saat ada aktivitas sistem atau balasan Admin</p>
    </div>
    @endif
</div>
@endsection
